...
#List of variables
Var_List <- scan("PIMS_Auswertung_Variablen.txt", what = character())

#select patients and variables
PIMS_all <- PIMS_all[case_id %in% Pat_List$Nr_unique]

PIMS_BN <- PIMS_all[, ..Var_List]
table(PIMS_BN$p2_img_cd_echo_cor_meas2)
#change date format
...
#one patient without date on follow-up: 1711-7 remove or find out.
...
```{r}
letter_combination <- "p2_lab"

# List all column names that start with the specified letter combination
matching_columns <- grep(paste0("^", letter_combination), colnames(PIMS_all), value = TRUE)
...
ggsave(paste0(dir, "/Followup.png"), width=4, height =3, dpi=600)
```
...
ggplot(df_filtered, aes(x = as.factor(Visit_Number), y = Time_Interval)) +
  geom_violin(trim = FALSE, color = "cornflowerblue") +
...
ggsave(paste0(dir, "/Intervals.png"), width=4, height =3, dpi=600)
```
...
View(df_any   %>% select(c("case_id", "Visit_Number", "any_p2_1", "any_persist", "p2_sy_sympt_type___1",  "p2_sy_sympt_type___2",  "p2_sy_sympt_type___3",  "p2_sy_sympt_type___4", 
 "p2_sy_sympt_type___5",  "p2_sy_sympt_type___6",  "p2_sy_sympt_type___7",  "p2_sy_sympt_type___8", "p2_sy_sympt_type___9",  "p2_sy_sympt_type___10", "p2_sy_sympt_type___11", "p2_sy_sympt_type___12",
"p2_sy_sympt_type___13", "p2_sy_sympt_type___14")))
...
```{r}
#clinical with linear regression
#Any symptom
...
# Generate plot
any_plot <- ggplot(plot_any, aes(x = factor(Visit_Number), y = count, 
                         fill = factor(any_p2_1, labels = c("No", "Yes")))) +
  geom_bar(stat = "identity", position = "stack") +
  geom_text(aes(label = count), position = position_stack(vjust = 0.5)) +
  scale_fill_manual(values = c("cornflowerblue", "brown")) +
...
# Generate plot
general_plot <- ggplot(plot_general, aes(x = factor(Visit_Number), y = count, 
                         fill = factor(general, labels = c("No", "Yes")))) +
  geom_bar(stat = "identity", position = "stack") +
  geom_text(aes(label = count), position = position_stack(vjust = 0.5)) +
  scale_fill_manual(values = c("cornflowerblue", "brown")) +
...
# Generate plot
cardio_plot <- ggplot(plot_cardio, aes(x = factor(Visit_Number), y = count, 
                         fill = factor(cardio, labels = c("No", "Yes")))) +
  geom_bar(stat = "identity", position = "stack") +
  geom_text(aes(label = count), position = position_stack(vjust = 0.5)) +
  scale_fill_manual(values = c("cornflowerblue", "brown")) +
...
# Generate plot
skin_plot <- ggplot(plot_skin, aes(x = factor(Visit_Number), y = count, 
...
# Generate plot
gastro_plot <- ggplot(plot_gastro, aes(x = factor(Visit_Number), y = count, 
...
# Generate plot
echo_plot <- ggplot(plot_echo, aes(x = factor(Visit_Number), y = count, 
                         fill = factor(echo_mod, labels = c("No", "Yes")))) +
  geom_bar(stat = "identity", position = "stack") +
  geom_text(aes(label = count), position = position_stack(vjust = 0.5)) +
  scale_fill_manual(values = c("cornflowerblue", "brown")) +
...
# Generate plot
myocard_plot <- ggplot(plot_myocard, aes(x = factor(Visit_Number), y = count, 
                         fill = factor(myocard_mod, labels = c("No", "Yes")))) +
  geom_bar(stat = "identity", position = "stack") +
  geom_text(aes(label = count), position = position_stack(vjust = 0.5)) +
  scale_fill_manual(values = c("cornflowerblue", "brown")) +
...
# Generate plot
coro_plot <-ggplot(plot_coronary, aes(x = factor(Visit_Number), y = count, 
                         fill = factor(coronary_mod, labels = c("No", "Yes")))) +
  geom_bar(stat = "identity", position = "stack") +
  geom_text(aes(label = count), position = position_stack(vjust = 0.5)) +
  scale_fill_manual(values = c("cornflowerblue", "brown")) +
...
View(df_cardio_model %>% select(c("case_id", "cardio_persist", "ICU", "Gender", "ppatient_age_years", "ppatient_bmi", "Comorb")))

model_cardio <- glm(cardio_persist ~ ICU + ppatient_age_years + Gender  + Comorb, data = df_cardio_model, family = binomial(link = "logit"))
...
rownames.model <- c("ICU (ref=no)", "Age (years)", "Gender (ref=male)", "Comorbidity (ref=no)")
...
View(df_general_model %>% select(c("case_id", "general_persist", "ICU", "Gender", "ppatient_age_years", "ppatient_bmi", "Comorb")))

model_general <- glm(general_persist ~ ICU + ppatient_age_years + Gender  + Comorb, data = df_general_model, family = binomial(link = "logit"))
...
model_any <- glm(any_persist ~ ICU + ppatient_age_years + Gender + Comorb, data = df_any_model, family = binomial(link = "logit"))
...
View(df_echo_model %>% select(c("case_id", "echo_persist", "ICU", "Gender", "ppatient_age_years",  "Comorb")))

model_echo <- glm(echo_persist ~ ICU + ppatient_age_years + Gender + Comorb, data = df_echo_model, family = binomial(link = "logit"))
